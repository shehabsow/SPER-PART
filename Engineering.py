...
""", unsafe_allow_html=True)
        ...
        with tab1:
            ...
            with col3:
                ...
                with SKF:
                    image1 = open('D:/DIPLOMA DATA/DIPLOMA DATA/Spare parts finl/New folder/1.jpeg', 'rb').read()
        ...
        with tab2:
            ...
            with col3:
                ...
                with timing_belt:
                    image10 = open('10.jpg', 'rb').read()
                    st.image(image10, width=200)
        ...
        with tab4:
            ...
            with col3:
                ...
                with TENSION:
                    image13 = open('13.jpg', 'rb').read()
                    st.image(image13, width=200)
                    url = 'https://www.sawane-spring.com/product/use/tension_spring_extension_spring.php'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')


                with PRESSURE:
                    image14 = open('14.jpg', 'rb').read()
                    st.image(image14, width=200)
        ...
        with tab5:
            ...
            with col3:
                ...
                with Alumnum:
                    image15 = open('15.jpg', 'rb').read()
                    st.image(image15, width=200)
                    url = 'https://www.jctprinting.com/'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with rubber:
                    image16 = open('16.jpeg', 'rb').read()
                    st.image(image16, width=200)
                    url = 'https://www.jctprinting.com/'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')
        ...
        with tab6:
            ...
            with col3:
                ...
                with Cam_SKF:
                    image17 = open('17.jpg', 'rb').read()
                    st.image(image17, width=200)
                    url = 'https://www.skf.com/sg/products/rolling-bearings/track-rollers/cam-followers/productid-KR%2022'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with Cam_INA:
                    image18 = open('18.jpg', 'rb').read()
                    st.image(image18, width=200)
                    url = 'https://www.abf.store/s/en/bearings/KR19-PP-A-NMT-INA/501413'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with Cam_IKO:
                    image19 = open('19.jpg', 'rb').read()
                    st.image(image19, width=200)
        ...
        with tab13:
            ...
            with col3:
                ...
                with Flexible_Couplin:
                    image30 = open('30.jpeg', 'rb').read()
                    st.image(image30, width=200)
                    url = 'https://www.ttco.com/encoders/ae087-10-10.html'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with BoWex_Couplin :
                    image31 = open('31.jpg', 'rb').read()
                    st.image(image31, width=200)
        ...
        with tab14:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image32 = open('32.jpg', 'rb').read()
                st.image(image32, width=200)
...
""", unsafe_allow_html=True)
        ...
        with tab1:
            ...
            with col3:
                ...
                with BALLUFF:
                    image57 = open('57.PNG', 'rb').read()
                    st.image(image57, width=200)
                    url = 'https://valinonline.com/products/dw-as-503-m30-002'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with MICRO_DETECTORS:
                    image58= open('58.PNG', 'rb').read()
                    st.image(image58, width=200)
                ...
                with IFM:
                    image59 = open('59.PNG', 'rb').read()
                    st.image(image59, width=200)
        ...
        with tab3:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image63 = open('63.PNG', 'rb').read()
                st.image(image63, width=200)
        ...
        with tab4:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image64 = open('64.PNG', 'rb').read()
                st.image(image64, width=200)
        ...
        with tab5:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image65 = open('65.PNG', 'rb').read()
                st.image(image65, width=200)
        ...
        with tab6:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image66 = open('66.PNG', 'rb').read()
                st.image(image66, width=200)
        ...
        with tab7:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image67= open('67.PNG', 'rb').read()
                st.image(image67, width=200)
        ...
        with tab8:
            ...
            with col3:
                ...
                with SICK:
                    image68 = open('68.PNG', 'rb').read()
                    st.image(image68, width=200)
                    url = 'https://www.sick.com/us/en/catalog/products/safety/safety-switches/re1/re11-sa03/p/p315664'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with MOUJEN:
                    image69= open('69.PNG', 'rb').read()
                    st.image(image69, width=200)
                    url = 'https://www.moujenswitch.com/product/me-8108-m/'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with SCHNEIDER:
                    image70 = open('70.PNG', 'rb').read()
                    st.image(image70, width=200)
        ...
        with tab10:
            ...
            with col3:
                st.subheader('image  for  these  part')
                image73= open('73.PNG', 'rb').read()
                st.image(image73, width=200)
        ...
        with tab11:
            ...
            with col3:
                ...
                with CONNECTION:
                    image74 = open('74.PNG', 'rb').read()
                    st.image(image74, width=200)
                    url = 'https://asi.net.nz/category/Sensor-Leads-Connectors-Valve-Cables'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with CAT6_CABLE:
                    image75= open('75.PNG', 'rb').read()
                    st.image(image75, width=200)
                ...
                with FIBER_OPTIC:
                    image76 = open('76.PNG', 'rb').read()
                    st.image(image76, width=200)
        ...
        with tab12:
            ...
            with col3:
                ...
                with GLASS:
                    image77 = open('77.PNG', 'rb').read()
                    st.image(image77, width=200)
                    url = 'https://makerselectronics.com/product/fuse-1a-250v-t5x20mm'
                    st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                with CRAMIC:
                    image78= open('78.PNG', 'rb').read()
                    st.image(image78, width=200)
...
""", unsafe_allow_html=True)
        ...
        if select_col == 'Water Station':
            ...
            with tab1:
                ...
                with col3:
                    st.subheader('image  for  these  part')
                    image33 = open('33.jpg', 'rb').read()
                    st.image(image33, width=200)
            ...
            with tab2:
                ...
                with col3:
                    st.subheader('image  for  these  part')
                    image34= open('34.PNG', 'rb').read()
                    st.image(image34, width=200)
            ...
            with tab3:
                ...
                with col3:
                    st.subheader('image  for  these  part')
                    image35= open('35.PNG', 'rb').read()
                    st.image(image35, width=200)
            ...
            with tab4:
                ...
                with col3:
                    st.subheader('image  for  these  part')
                    image36= open('36.PNG', 'rb').read()
                    st.image(image36, width=200)
            ...
            with tab5:
                ...
                with col3:
                    st.subheader('image  for  these  part')
                    image37= open('37.PNG', 'rb').read()
                    st.image(image37, width=200)
            ...
            with tab6:
                ...
                with col3:
                    st.subheader('image  for  these  part')
                    image38= open('38.PNG', 'rb').read()
                    st.image(image38, width=200)
            ...
            with tab8:
                ...
                with col3:
                    ...
                    with pressure_transmitter:
                        image39 = open('39.PNG', 'rb').read()
                        st.image(image39, width=200)
                    ...
                    with Angle_Valve :
                        image40 = open('40.PNG', 'rb').read()
                        st.image(image40, width=200)
            ...
            with tab9:
                ...
                with col3:
                    ...
                    with PHOTOMETERS:
                        image42 = open('42.PNG', 'rb').read()
                        st.image(image42, width=200)
                        url = 'https://www.hannaservice.eu/water/environmental/photometers'
                        st.components.v1.html(f'<a href="{url}" target="_blank" style="background-color: #FFD700;">Go to Web Page</a>')

                    with Colorimetric:
                        image41 = open('41.PNG', 'rb').read()
                        st.image(image41, width=200)
            ...
            with col3:
                st.subheader('image  for  these  part')
                image45 = open('45.jpeg', 'rb').read()
                st.image(image45, width=200)
            ...
            with col3:
                st.subheader('image  for  these  part')
                image46 = open('46.jpeg', 'rb').read()
                st.image(image46, width=200)
