        ...
        def tab_content(tab_name):
            ...
            with col2:
                ...
                if search_button and search_keyword:
                    st.session_state[f'{tab_name}_search_keyword'] = search_keyword
                    st.session_state[f'{tab_name}_search_results'] = search_in_dataframe(df_f, search_keyword, 'All Columns')
            ...
            with col1:
                ...
                if st.session_state.get(f'{tab_name}_search_keyword', ''):
                    st.write(f"Search results for '{st.session_state[f'{tab_name}_search_keyword']}':")
                    st.dataframe(st.session_state[f'{tab_name}_search_results'], width=1500, height=200)
